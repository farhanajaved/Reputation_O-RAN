...
fig, axes = plt.subplots(2, 3, figsize=(8, 5), sharey=True, sharex=True)
...
for i, user in enumerate(selected_users):
    ...
    ax.legend(loc='upper left', fontsize=8)  # Adjust the fontsize here
...
plt.savefig('/home/fjaved/demos/hardhat-polygon/test/test_FL/Plots_FL/cdf_registration_time.png')
plt.savefig('/home/fjaved/demos/hardhat-polygon/test/test_FL/Plots_FL/cdf_registration_time.svg')
